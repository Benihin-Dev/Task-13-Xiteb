...
export default function MiddleSection({
  showSlideUpBtn,
  bottomSectionStateFoeSlide,
  setBottomSectionStateFoeSlide,
  setSearchBoxState,
  searchBoxState,
}) {
    ...
    <>
          ...
          <ul className=" flex gap-5 items-center">
            ...
            {showSlideUpBtn && (
              <li className=" relative  ">
                <FaBars
                  onClick={() => {
                    setBottomSectionStateFoeSlide(!bottomSectionStateFoeSlide);
                  }}
                  className=" size-[22px] text-gray-500 duration-300 hover:text-[#66bc89] cursor-pointer"
                />
              </li>
            )}
          </ul>
      ...
      {showSlideUpBtn && (
        <div className=" slideDown1">
          {bottomSectionStateFoeSlide && <BottomSection />}
        </div>
      )}
    </>
  );
